...
function Footer() {
    ...
    return (
        <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-18 bg-primary/15">
            <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30 text-gray-500">
                <div>
                    <img
                        className="w-34 md:w-76"
                        src={assets.basket_logo}
                        alt="logo"
                    />
            ...
            <p className="py-4 text-center text-sm md:text-base text-gray-500/80">
                Copyright 2025 © <span className='text-primary-dull font-semibold'> GreenBasket </span> | All Right Reserved.
            </p>
        </div>
    );
}
